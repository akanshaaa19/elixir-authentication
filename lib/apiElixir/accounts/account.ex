defmodule ApiElixir.Accounts.Account do
  use Ecto.Schema
  ...
  schema "accounts" do
    ...
    has_one :user, ApiElixir.Users.User
  ...
  def changeset(account, attrs) do
    ...
    |> validate_format(:email, ~r/^[^\s]+@[^\s]+$/, message: "email is invalid")
    |> validate_length(:hashed_password, min: 8, max: 100)
